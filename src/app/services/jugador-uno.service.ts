...
export class JugadorUnoService {
  ...
  getPoints(dices: number[], verficacion: boolean) {
    if (dices[0] == dices[4] && this.restricciones[0][1] == 0) {
    ...
    } else if ((dices[0] == dices[3] && dices[0] != dices[4] && this.restricciones[1][1] == 0)
      || (dices[1] == dices[4] && dices[0] != dices[1] && this.restricciones[1][1] == 0)
    ) {
      if (verficacion) {
    ...
    } else if ((dices[0] == dices[2] && dices[3] == dices[4] && dices[0] != dices[4] && this.restricciones[2][1] == 0)
      || (dices[0] == dices[1] && dices[2] == dices[4] && dices[0] != dices[4] && this.restricciones[2][1] == 0)) {
      if (verficacion) {
      ...
      ((dices[0] + 1) == dices[1] && (dices[0] + 2) == dices[2] && (dices[0] + 3) == dices[3] && (dices[0] + 4) == dices[4] && this.restricciones[3][1] == 0)
    ) {
      if (verficacion) {
  ...
  valoresNumericos(dices: number[]) {
    ...
    if (dices[3] == dices[4] && dices[3] == dices[2]) { //chequea los tres ultimos numeros
      ...
      if (dices[0] == 5 && this.restricciones[8][1] == 0) {
        this.sumatoriaJugadorUno += (dices[0] * 3);
        this.restricciones[8][1] = 15;
        this.msj = "Obtuviste valor numerico: 15";
      } else if (dices[0] == 4 && this.restricciones[7][1] == 0) {
        this.sumatoriaJugadorUno += (dices[0] * 3);
        this.restricciones[7][1] = 12;
        this.msj = "Obtuviste valor numerico: 12";
      } else if (dices[0] == 3 && this.restricciones[6][1] == 0) {
        this.sumatoriaJugadorUno += (dices[0] * 3);
        this.restricciones[6][1] = 9;
        this.msj = "Obtuviste valor numerico: 9";
      } else if (dices[0] == 2 && this.restricciones[5][1] == 0) {
        this.sumatoriaJugadorUno += (dices[0] * 3);
        this.restricciones[5][1] = 6;
        this.msj = "Obtuviste valor numerico: 6";
      } else if (dices[0] == 1 && this.restricciones[4][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[0] * 3);
    ...
    if (dices[3] == dices[4] && this.sumatoriaJugadorUno == auxiliarUno) { //comparando si solo los ultimos 2 dados son iguales
      if (dices[3] == 6 && this.restricciones[9][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[3] * 2);
          this.restricciones[9][1] = 12;
          this.msj = "Obtuviste valor numerico: 12";
      } else if (dices[3] == 5 && this.restricciones[8][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[3] * 2);
          this.restricciones[8][1] = 10;
          this.msj = "Obtuviste valor numerico: 10";
      } else if (dices[3] == 4 && this.restricciones[7][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[3] * 2);
          this.restricciones[7][1] = 8;
          this.msj = "Obtuviste valor numerico: 8";
      } else if (dices[3] == 3 && this.restricciones[6][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[3] * 2);
          this.restricciones[6][1] = 6;
          this.msj = "Obtuviste valor numerico: 6";
      } else if (dices[3] == 2 && this.restricciones[5][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[3] * 2);
          this.restricciones[5][1] = 4;
          this.msj = "Obtuviste valor numerico: 4";
      }
    }
    if (dices[3] == dices[2] && this.sumatoriaJugadorUno == auxiliarUno ) { //comparando si los ados 3 y 4 son iguales
      if (dices[3] == 5 && this.restricciones[8][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[3] * 2);
          this.restricciones[8][1] = 10;
          this.msj = "Obtuviste valor numerico: 10";
      } else if (dices[3] == 4 && this.restricciones[7][1] == 0 ) {
    ...
    if (dices[1] == dices[2] && this.sumatoriaJugadorUno == auxiliarUno ) { //comparando si los ados 2 y 3 son iguales
      if (dices[1] == 5 && this.restricciones[8][1] == 0) {
          this.sumatoriaJugadorUno += (dices[1] * 2);
          this.restricciones[8][1] = 10;
          this.msj = "Obtuviste valor numerico: 10";
      } else if (dices[1] == 4 && this.restricciones[7][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[1] * 2);
          this.restricciones[7][1] = 8;
          this.msj = "Obtuviste valor numerico: 8";
      } else if (dices[1] == 3 && this.restricciones[6][1] == 0 ) {
          this.sumatoriaJugadorUno += (dices[1] * 2);
          this.restricciones[6][1] = 6;
          this.msj = "Obtuviste valor numerico: 6";
      } else if (dices[1] == 2 && this.restricciones[5][1] == 0) {
          this.sumatoriaJugadorUno += (dices[1] * 2);
          this.restricciones[5][1] = 4;
          this.msj = "Obtuviste valor numerico: 4";
        }
    }
    if (dices[1] == dices[0] && this.sumatoriaJugadorUno == auxiliarUno ) { //comparando si los ados 2 y 1 son iguales
      if (dices[1] == 5 && this.restricciones[8][1] == 0) {
          this.sumatoriaJugadorUno += (dices[1] * 2);
          this.restricciones[8][1] = 10;
          this.msj = "Obtuviste valor numerico: 10";
          ...
          this.restricciones[5][1] = 4;
          this.msj = "Obtuviste valor numerico: 4";
      } else if (dices[1] == 1 && this.restricciones[4][1] == 0 ) {
